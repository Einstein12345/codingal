...
-- Create a table "noble_win" and write a query to find all the details of the Nobel winners for the subject not started with the letter 'P'
--  and arrange the list as the most recent comes first, then by name in order.
